          ...
          <nav className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center space-x-6 mr-6">
              <div className="group relative">
                <button
                  onClick={() => {
                    const userId = userData?.manager_id || "";
                    navigate(`/home/${userId}`);
                  }}
                  className="px-2 py-1.5 text-white text-sm uppercase tracking-wider font-medium transition-all duration-200 cursor-pointer"
                >
                  Form
                </button>
